...
class DailyEventListPage extends StatelessWidget {
  ...
  DailyEventListPage(
      {@required EventBloc eventBloc, @required FavoriteBloc favoriteBloc, @required DateTime day, Key key})
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: DailyEventList(day: _day, eventBloc: _eventBloc, key: _key, favoriteBloc: _favoriteBloc,),
    );
  }
}
